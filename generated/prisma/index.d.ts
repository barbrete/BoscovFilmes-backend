...
export namespace Prisma {
  ...
  */
  ...
  export type UsuarioOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "nome" | "data_nascimento" | "email" | "apelido" | "password" | "status" | "createdAt" | "updatedAt" | "tipo_usuario", ExtArgs["result"]["usuario"]>
  ...
  export type FilmeOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "nome" | "diretor" | "anoLancamento" | "duracao" | "produtora" | "classificacao" | "poster", ExtArgs["result"]["filme"]>
  ...
  export type GeneroFilmeOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"idFilme" | "idGenero", ExtArgs["result"]["generoFilme"]>
  ...
  export interface GeneroFilmeDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `idFilme`
     * const generoFilmeWithIdFilmeOnly = await prisma.generoFilme.findMany({ select: { idFilme: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many GeneroFilmes and only return the `idFilme`
     * const generoFilmeWithIdFilmeOnly = await prisma.generoFilme.createManyAndReturn({
     *   select: { idFilme: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more GeneroFilmes and only return the `idFilme`
     * const generoFilmeWithIdFilmeOnly = await prisma.generoFilme.updateManyAndReturn({
     *   select: { idFilme: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  export type $GeneroPayload<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    name: "Genero"
    objects: {
      filmes: Prisma.$GeneroFilmePayload<ExtArgs>[]
    }
    scalars: $Extensions.GetPayloadResult<{
      id: number
      descricao: string
  ...
  export interface Prisma__GeneroClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    filmes<T extends Genero$filmesArgs<ExtArgs> = {}>(args?: Subset<T, Genero$filmesArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$GeneroFilmePayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
  ...
  export type GeneroFilmeWhereUniqueInput = Prisma.AtLeast<{
    idFilme_idGenero?: GeneroFilmeIdFilmeIdGeneroCompoundUniqueInput
    AND?: GeneroFilmeWhereInput | GeneroFilmeWhereInput[]
    OR?: GeneroFilmeWhereInput[]
    NOT?: GeneroFilmeWhereInput | GeneroFilmeWhereInput[]
    idFilme?: IntFilter<"GeneroFilme"> | number
  ...
  export type GeneroWhereInput = {
    ...
    filmes?: GeneroFilmeListRelationFilter
  }

  export type GeneroOrderByWithRelationInput = {
    id?: SortOrder
    descricao?: SortOrder
    filmes?: GeneroFilmeOrderByRelationAggregateInput
  }
  ...
  export type GeneroCreateInput = {
    descricao: string
    filmes?: GeneroFilmeCreateNestedManyWithoutGeneroInput
  }

  export type GeneroUncheckedCreateInput = {
    id?: number
    descricao: string
    filmes?: GeneroFilmeUncheckedCreateNestedManyWithoutGeneroInput
  }

  export type GeneroUpdateInput = {
    descricao?: StringFieldUpdateOperationsInput | string
    filmes?: GeneroFilmeUpdateManyWithoutGeneroNestedInput
  }

  export type GeneroUncheckedUpdateInput = {
    id?: IntFieldUpdateOperationsInput | number
    descricao?: StringFieldUpdateOperationsInput | string
    filmes?: GeneroFilmeUncheckedUpdateManyWithoutGeneroNestedInput
  }
  ...
  export type GeneroFilmeIdFilmeIdGeneroCompoundUniqueInput = {
    idFilme: number
    idGenero: number
  }
